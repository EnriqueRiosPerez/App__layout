...
let Buton_Modal = document.getElementById("Buton_Modal")
Buton_Modal.addEventListener("click",()=>{
	let dialog = document.getElementById("Openomodal")
	dialog.showModal()
})
